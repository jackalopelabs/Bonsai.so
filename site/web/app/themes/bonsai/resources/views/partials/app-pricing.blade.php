<div id="grid" class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-6">
      <div class="card mx-2 mt-5 pointer" data-toggle="modal" data-target="#appPricingModal01">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card mx-2 mt-5 pointer gradient-border" id="box" data-toggle="modal" data-target="#appPricingModal02">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card mx-2 mt-5 pointer" data-toggle="modal" data-target="#appPricingModal03">
...
@include('partials.modals.app-pricing01')
@include('partials.modals.app-pricing02')
@include('partials.modals.app-pricing03')
